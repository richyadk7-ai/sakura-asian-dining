...
const coursesSchema = z.array(z.object({
  ...
  allYouCanEat: z.boolean(), allYouCanDrink: z.boolean(), tabelogUrl: z.url().refine((url) => url.startsWith("https://tabelog.com/"), "Course URL must be on tabelog.com"), imageId: z.string().optional(), enabled: z.boolean(),
}));
