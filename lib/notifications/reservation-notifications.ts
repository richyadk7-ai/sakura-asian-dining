...
function emailCopy(event: ReservationNotificationEvent, locale: Locale) {
  ...
  if (event === "customer_confirmed") return {
    badge: ja ? "予約承認・確定" : "ACCEPTED · CONFIRMED",
  ...
  return {
    badge: ja ? "確認中・承認待ち" : "ON HOLD · AWAITING DECISION",
